<template>
    <div>
      ...
      <div id="top_buttons">
        ...
        <el-button size="small" @click="searchByDisease(disease_name, risk)" type="primary" icon="el-icon-search">搜索</el-button>
        <el-button size="small" @click="clearFilter"  type="primary" icon="el-icon-delete">清除</el-button>
        <el-button id="add" type="warning" size="middle" @click="add()">添加知识</el-button>
      ...
      <div id="table">
        ...
        >
          ...
          <el-table-column label="疾病名称" prop="diseaseName" width="150" show-overflow-tooltip> </el-table-column>
          <el-table-column label="危险特征" prop="riskFactorsCn" width="150"> </el-table-column>
          <!-- <el-table-column
            label="疾病描述"
            prop="disasterDesc"
            width="140"
          ...
          ></el-table-column> -->
          <el-table-column label="是否有异常范围" prop="isException" width="150">
          </el-table-column>
          <el-table-column label="低于正常值" prop="exceptionLow" width="150">
          </el-table-column>
          <el-table-column label="高于正常值" prop="exceptionUp" width="150">
          </el-table-column>
          <el-table-column label="知识解释" prop="exceptionExplain" > 
            <!-- show-overflow-tooltip -->
          </el-table-column>
          <el-table-column label="知识来源" prop="resource" >
          </el-table-column>
      ...
      <el-dialog title="添加知识" :visible.sync="addVisible">
          <el-form :model="addForm" ref="addFormRef" :rules="rules2" label-width="80px">
          <el-form-item label="疾病名称" prop="diseaseName">
          ...
          <div slot="footer" class="dialog-footer">
              ...
              <el-button type="primary" @click="submitaddForm('addFormRef')" size="small">保存</el-button>
          </div>
      </el-dialog>
...
export default {
    ...
    methods: {
      ...
      getList() {
        ...
        // 获取知识库所有疾病
        getRequest("/ten/knowledge/disease").then((res)=>{          
        ...
        // 获取知识库所有危险因素
        getRequest("/ten/knowledge/risks").then((res)=>{          
          this.risks = res.data;           
        }).catch(error=>{
          console.log(error);
        })
      ...
      searchByDisease(disease_name, risks){
        ...
        getRequest("/ten/knowledge/search", {"disease_name" :disease_name, "risks" :risks}).then((res)=>{
      ...
      handleEdit(index, row) {
       ...
       handleDelete(index, id) {
        ...
        getRequest("/ten/knowledge/delete/" + id).then((res)=>{
      ...
      submitForm() {
        ...
        this.$refs.dialogFormRef.validate((valid) => {
          if (valid) {
            if (this.editIndex !== -1) {
              this.knowledges[this.editIndex].diseaseName = this.dialogForm.diseaseName;
              this.knowledges[this.editIndex].riskFactorsCn = this.dialogForm.riskFactorsCn;
              this.knowledges[this.editIndex].isException = this.dialogForm.isException;
              this.knowledges[this.editIndex].exceptionLow = this.dialogForm.exceptionLow;
              this.knowledges[this.editIndex].exceptionUp = this.dialogForm.exceptionUp;
              this.knowledges[this.editIndex].exceptionExplain = this.dialogForm.exceptionExplain;
